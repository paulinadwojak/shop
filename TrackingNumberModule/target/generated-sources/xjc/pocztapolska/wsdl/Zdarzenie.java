...
public class Zdarzenie {
    ...
    @XmlElementRef(name = "czas", namespace = "http://ws.sledzenie.pocztapolska.pl/xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<String> czas;
    @XmlElementRef(name = "jednostka", namespace = "http://ws.sledzenie.pocztapolska.pl/xsd", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "przyczyna", namespace = "http://ws.sledzenie.pocztapolska.pl/xsd", type = JAXBElement.class, required = false)
