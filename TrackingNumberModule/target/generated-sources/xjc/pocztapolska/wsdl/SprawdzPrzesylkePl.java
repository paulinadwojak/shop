...
@XmlRootElement(name = "sprawdzPrzesylkePl")
public class SprawdzPrzesylkePl {

    @XmlElementRef(name = "numer", namespace = "http://sledzenie.pocztapolska.pl", type = JAXBElement.class, required = false)
