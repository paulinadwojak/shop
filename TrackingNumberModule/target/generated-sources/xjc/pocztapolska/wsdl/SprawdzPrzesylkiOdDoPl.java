...
@XmlRootElement(name = "sprawdzPrzesylkiOdDoPl")
public class SprawdzPrzesylkiOdDoPl {

    @XmlElement(nillable = true)
    protected List<String> numer;
    @XmlElementRef(name = "odDnia", namespace = "http://sledzenie.pocztapolska.pl", type = JAXBElement.class, required = false)
    protected JAXBElement<String> odDnia;
    @XmlElementRef(name = "doDnia", namespace = "http://sledzenie.pocztapolska.pl", type = JAXBElement.class, required = false)
